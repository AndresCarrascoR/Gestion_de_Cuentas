    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linea_negocio', models.CharField(blank=True, max_length=255, null=True)),
                ('condiciones_domicilio', models.CharField(blank=True, max_length=50, null=True)),
                ('tipo_persona', models.CharField(blank=True, max_length=50, null=True)),
                ('departamento', models.CharField(blank=True, max_length=100, null=True)),
                ('provincia', models.CharField(blank=True, max_length=100, null=True)),
                ('distrito', models.CharField(blank=True, max_length=100, null=True)),
                ('ubigeo', models.CharField(blank=True, max_length=6, null=True)),
                ('fecha_creacion_ruc', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('accountant', 'Contador'), ('manager', 'Gerente')], default='admin', max_length=20)),
